...
int INTD_API_getData(INTD_struc_node *dataNode, unsigned int pno, void *data)
{
    ...
    if(pno > 1) {                                                   /* array */
        ...
        switch(dataNode -> dataType) {
            ...
            //case INTD_OLDSTRING: *((epicsOldString  *)data) = *((epicsOldString  *)dataNode -> dataPtr); break;
...
int INTD_API_putData(INTD_struc_node *dataNode, unsigned int pno, void *data)
{
    ...
    if(pno > 1) {                                                   /* array */
        ...
        switch(dataNode -> dataType) {
            ...
            //case INTD_OLDSTRING: *((epicsOldString  *)dataNode -> dataPtr) = *((epicsOldString  *)data); break;
